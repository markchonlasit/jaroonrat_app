...
import 'audit.dart';
import 'History_audit.dart';

class SafetylistPage extends StatefulWidget {
  ...
  @override
  State<SafetylistPage> createState() => _SafetylistPageState();
}

class _SafetylistPageState extends State<SafetylistPage> {
  String keyword = '';
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          // 🔹 ส่วนที่ 3: ACTION BUTTONS (ตรวจสภาพ, ประวัติ)
          Column(
            children: [
              // ชื่ออุปกรณ์
