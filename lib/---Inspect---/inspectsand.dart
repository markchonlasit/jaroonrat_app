...
class InspectSandPage extends StatefulWidget {
  final int assetId;
  final String assetName;

  const InspectSandPage({
    super.key,
  ...
  @override
  State<InspectSandPage> createState() => _InspectFirePageState();
}

class _InspectFirePageState extends State<InspectSandPage> {
  bool isLoading = true;
