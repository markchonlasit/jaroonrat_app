...
class InspectAlarmPage extends StatefulWidget {
  final int assetId;
  final String assetName;

  const InspectAlarmPage({
    super.key,
  ...
  @override
  State<InspectAlarmPage> createState() => _InspectFirePageState();
}

class _InspectFirePageState extends State<InspectAlarmPage> {
  bool isLoading = true;
