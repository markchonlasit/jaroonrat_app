...
class InspectfhcPage extends StatefulWidget {
  final int assetId;
  final String assetName;

  const InspectfhcPage({
    super.key,
  ...
  @override
  State<InspectfhcPage> createState() => _InspectFirePageState();
}

class _InspectFirePageState extends State<InspectfhcPage> {
  bool isLoading = true;
