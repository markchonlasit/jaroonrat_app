...
class InspectLightPage extends StatefulWidget {
  ...
  @override
  State<InspectLightPage> createState() => _InspectLightPageState();
}

class _InspectLightPageState extends State<InspectLightPage> {
  bool isLoading = true;
  List checklist = [];
  ...
  Widget _buildUI() {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.green, title: Text(widget.assetName , style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
      body: isLoading
