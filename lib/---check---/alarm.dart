...
class _AlarmPageState extends State<AlarmPage> {
  ...
  final String apiUrl = 'https://api.jaroonrat.com/safetyaudit/api/assetlist/3';
  ...
  Widget _summaryCard(int total, int filtered) {
    ...
    const categoryName = 'สัญญาณเเจ้งเหตุ';
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Column(
            children: [
              const Icon(Icons.warning_amber, size: 46, color: Colors.orange),
            ...
            children: [
              ...
              _actionButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const AuditAlarmDetailPage(auditedAssetIds: [])),
                  );
                },
                icon: Icons.history,
                label: 'ประวัติ',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('สัญญาณเเจ้งเหตุทั้งหมด', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ),
      body: isLoading
