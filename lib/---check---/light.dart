...
class _LightPageState extends State<LightPage> {
  ...
  final String apiUrl = 'https://api.jaroonrat.com/safetyaudit/api/assetlist/7';
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Column(
            children: [
              const Icon(Icons.flash_on, size: 46, color: Colors.green),
            ...
            children: [
              ...
              _actionButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const AuditLightDetailPage(auditedAssetIds: [])),
                  );
                },
                icon: Icons.history,
                label: 'ประวัติ',
